...
public class ArtRoundButton extends Button {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ArtRoundView);
            roundWidth= a.getDimensionPixelSize(R.styleable.ArtRoundView_roundWidth, roundWidth);
            roundHeight= a.getDimensionPixelSize(R.styleable.ArtRoundView_roundHeight, roundHeight);
        }else {
